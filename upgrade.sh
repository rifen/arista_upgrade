...
./cvpi/tools/backup.py || echo -en "Couldn't execute ./cvpi/tools/backup.py backup completely" && exit
wait
./cvpi/tools/backup.sh || echo -en "Couldn't execute ./cvpi/tools/backup.sh backup completely" && exit
